...
[u, pred] = triinvx('testmesh-dip.msh', s, 100); % Same model but specifying the fault file as an input string and requesting predicted displacement field
...
[u_rev, pred_rev] = triinvx(p, s, 100, 'nneg', [0 1]);
...
[u_rev_noedge, pred_rev_noedge] = triinvx(p, s, 100, 'nneg', [0 1], 'lock', [1 1 1]);
...
[u_tvr, pred_tvr] = triinvx(p, s, 1e-2, 'tvr', true, 'outstruct', true);
